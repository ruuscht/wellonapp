          ...
          <ListGroup variant="flush">
            ...
            <ListGroup.Item>
              ...
              {order.isPaid ? (
                ...
                <Message variant="danger">Inte Betald</Message>
              )}
            </ListGroup.Item>
            ...
            <ListGroup.Item>
              ...
              {order.orderItems.length === 0 ? (
                <Message>Inga produkter</Message>
              ) : (
                <ListGroup variant="flush">
                  {order.orderItems.map((item, index) => (
                    <ListGroup.Item key={index}>
                      <Row>
                        ...
                        <Col md={4}>
                          {item.qty} x {item.price} Kr = {item.qty * item.price}{" "}
                          Kr
                        </Col>
                      </Row>
                    </ListGroup.Item>
          ...
          <Card>
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <Row>
                  <Col>Leverans</Col>
                  <Col>{order.shippingPrice} Kr</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
